    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('menu.update', $menu->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ $menu->getName() }}" name="name" id="product-name"
                                class="form-control" placeholder="e.g : Burger, Fries">
                        </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="mb-3">
                ...
                <input value="{{ $menu->price }}" name="price" type="text" class="form-control" id="product-price"
