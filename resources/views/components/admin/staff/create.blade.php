    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('staff.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            <label for="product-name" class="form-label">Middle Name<span
                        ...
                        <div class="mb-3">
                            <label for="product-description" class="form-label">Address<span
                                    class="text-danger">*</span></label>
                            <textarea class="form-control" name="address" rows="3" placeholder="Add description"></textarea>
                        </div>

                        <label for="">Schedule Staff</label>
                        <div class="mb-3 mt-2">
        ...
        <div class="col-lg-6">
            ...
            <div class="mb-3">
                ...
                <input type="text" maxlength="5" name="salary" class="form-control"
                    placeholder="Enter manufacturer's name">
            </div>

            <div class="mb-3">
                <label for="product-price">Emergency #</label>
                <input type="text" maxlength="11" name="emergency_number" class="form-control"
                    placeholder="Enter manufacturer's name">
            </div>
