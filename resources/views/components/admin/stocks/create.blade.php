...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">Add item</h5>
                <form action="{{ route('stocks.store') }}" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="product-name" class="form-label">Item name<span class="text-danger">*</span></label>
                        <input type="text"  name="item" class="form-control" placeholder="Enter the name of the item">
                    </div>

                    <div class="mb-3">
                        <label for="product-price">Manufacturer<span class="text-danger">*</span></label>
                        <input  name="manufacturer" type="text" class="form-control"  placeholder="Enter manufacturer's name">
                    </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="mb-3">
                    ...
                    <input  name="cost" type="number" class="form-control"  placeholder="Enter the price per item">
                </div>
