                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1">₱<span
                                        data-plugin="counterup">{{ $transactions->sum('amount') }}</span></h3>
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ $transactions->count() }}</span>
                                </h3>
                        ...
                        <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" id="tickets-table">
                            ...
                            <tbody>
                                @foreach ($transactions as $transaction)
                                    <tr>
                                        <td><a
                                                href="{{ route('order_details', $transaction->order_id) }}">{{ $transaction->order_id }}</a>
                                        </td>
